...
use App\EventHandler\Crm\DealEventHandler;
...
class Application
{
    ...
    protected static function processRemoteEvents(EventInterface $b24Event): void
    {
        ...
        switch ($b24Event->getEventCode()) {
            ...
            case 'ONCRMDEALUPDATE':
                ...
                DealEventHandler::onUpdate($b24Event);
    ...
    public static function getLog(): LoggerInterface
    {
        ...
        if ($logger === null) {
            ...
            // rotating
            $rotatingFileHandler = new RotatingFileHandler(dirname(__DIR__) . self::LOG_FILE_NAME, (int)$_ENV['BITRIX24_PHP_SDK_LOG_MAX_FILES_COUNT'], (int)$_ENV['BITRIX24_PHP_SDK_LOG_LEVEL']);
